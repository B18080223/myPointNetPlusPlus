...
def parse_args():
    ...
    parser.add_argument('--num_category', default=2, type=int, choices=[2, 10, 40],  help='training on ModelNet2/10/40')
...
def main(args):
    ...
    data_path = 'data/modelnet40_normal_resampled/' #加载的数据路径
